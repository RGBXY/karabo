...
<div class="w-full lg:w-[75%] h-full relative">
    ...
    <div class="p-4 border-b border-black ">
        <div class="flex justify-between items-center">
            <h1 class="font-extrabold text-xl hidden lg:block">Jawaban</h1>
            ...
            <div class="flex gap-3">
                ...
                <select class="rounded-lg border-2 border-slate-300 shadow-md focus:ring-0 border-none" name="forma" onchange="location = this.value;">
                    ...
                    <option selected value="/dashboard/laporan/jawaban">Jawaban</option>
...
<div class="overflow-scroll no-scrollbar z-10  overflow-x-auto h-[76vh]" style="">
