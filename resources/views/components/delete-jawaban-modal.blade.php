            ...
            <div class="p-4 md:p-5 text-center">
                ...
                <div class="flex justify-center w-full">
                    <form method="post" action="{{ route('jawaban.destroy', ['jawaban' => $jawaban]) }}">
                        @csrf
                        @method('delete')
                        <button type="submit" data-modal-hide="popup-modal-{{$jawaban->id}}" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">Delete</button>
                    </form>
